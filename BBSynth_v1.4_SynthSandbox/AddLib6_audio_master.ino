...
//  wavetable1.setInstrument(); // TODO: wavetable instruments
  ...
  wavetable1.setInstrument(Flute_100kbyte);    //hardcoded instrument
...
void updateSynthParams(float freq, float ampl) {
    switch(activeSynthMode) {
    case STRING:
//      playString(freq, nidx);
      break;
    case WAVETABLE:
      updateWavetable(freq, ampl);
      break;
    case WAVEFORM:
      playWaveform(freq, ampl, true);
      break;
    case DRUM:
//      playString(freq, nidx);
      break;
...
//  if (bar1TouchActive) {
//    //update params
//    updateSynthParams(freq, normAmpl);
//  }
//  else if (onOff && !bar1TouchActive) {
//    //note-on/off
//    playFreqNote(freq, normAmpl, onOff);
//  }
